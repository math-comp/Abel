...
by move=> u v uU vU; apply/UU/memv_mul.
Qed.
...
Lemma galois_subW (F0 : fieldType) (L : splittingFieldType F0)
  (E F : {subfield L}) : galois E F -> (E <= F)%VS.
...
Section Coef_root_relations.

Lemma big_if (R : Type) (idx : R) (op : Monoid.com_law idx) (I : Type)
